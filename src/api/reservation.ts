...
export function updateReservation(id: string, data: Reservation) {
...
export function auditReservation(id: string, data: AuditRequest) {
  return request.put(`/reservations/${id}/audit`, data) as Promise<ApiResponse<Reservation>>
}

export function returnVehicle(id: string, data: ReturnRequest) {
  return request.put(`/reservations/${id}/return`, data) as Promise<ApiResponse<Reservation>>
}

export function getSchedule(vehicleId?: string | null, from?: string, to?: string) {
