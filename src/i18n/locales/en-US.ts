export default {
  ...
  vehicle: {
    ...
    templateHint: 'Please download the template first, fill in the data according to the template format, then upload',
  ...
  profile: {
    ...
    currentPasswordPlaceholder: 'Please enter your current password to confirm',
    saveSuccess: 'Profile updated successfully',
    reloginRequired: 'Username has been changed, please log in again',
    usernameRequired: 'Please enter your username',
    emailRequired: 'Please enter your email',
    emailInvalid: 'Please enter a valid email',
